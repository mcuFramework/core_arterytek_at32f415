...
#include "middlewares/usb_conf.h"
#include "middlewares/usb_core.h"
#include "middlewares/usbd_int.h"
#include "middlewares/custom_hid_class.h"
#include "middlewares/custom_hid_desc.h"
 ...
 * @return false 
 */
bool CoreHumanInterfaceDevices::write(OutputBuffer& outputBuffer, mcuf::io::Future& future){
  if(!future.isIdle())
    return false;
