...
//-----------------------------------------------------------------------------------------
#include "arterytek/at32f415/general/CoreGeneralPortReg.h"
#include "arterytek/at32f415/general/InputMode.h"
#include "arterytek/at32f415/general/OutputMode.h"
 ...
 * Class Object
 */  
class arterytek::at32f415::general::CoreGeneralPort extends mcuf::lang::Object implements 
   ...
   */
  private: 
    arterytek::at32f415::general::CoreGeneralPortReg mRegister;
  ...
  public:
     ...
     * @return false 
     */
    bool configInput(uint32_t pin, arterytek::at32f415::general::InputMode mode);
     ...
     * @return false 
     */
    bool configOutput(uint32_t pin, arterytek::at32f415::general::OutputMode mode, 
                      bool opendrain, 
                      bool function, 
                      bool value);
