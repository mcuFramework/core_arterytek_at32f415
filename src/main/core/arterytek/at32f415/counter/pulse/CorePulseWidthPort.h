...
//-----------------------------------------------------------------------------------------
#include "core/arterytek/at32f415/counter/pulse/CorePulseWidthReg.h"
...
class core::arterytek::at32f415::counter::pulse::CorePulseWidthPort extends mcuf::lang::Object implements
   ...
   */
  protected:
    core::arterytek::at32f415::counter::pulse::CorePulseWidthReg mRegister;
  ...
  public:
     ...
     * @param reg 
     */
    CorePulseWidthPort(core::arterytek::at32f415::counter::pulse::CorePulseWidthReg reg);
