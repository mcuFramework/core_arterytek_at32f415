...
extern void arterytek_at32f415_usb_CoreHumanInterfaceDevices_onTransfer(void);
extern void arterytek_at32f415_usb_CoreHumanInterfaceDevices_onReceiver(void *udev, uint8_t *report, uint16_t len);
...
/**
  ...
  */
static void usb_hid_buf_process(void *udev, uint8_t *report, uint16_t len){
  arterytek_at32f415_usb_CoreHumanInterfaceDevices_onReceiver(udev, report, len);
}
